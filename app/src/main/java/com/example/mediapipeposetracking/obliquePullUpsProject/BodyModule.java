...
//        System.out.println("threshold_leg_angle:"+threshold_leg_angle);
    ...
    //检测身体是否挺直
    public static boolean isBodyStright(Point Shoulder,Point Hip,Point Keen,Point Ankle,int threshold_body_leg_angle){
        //假设所需关键点已经全部检测到
        float angle = utils.calAngle(Shoulder,Hip,Hip,Ankle);
